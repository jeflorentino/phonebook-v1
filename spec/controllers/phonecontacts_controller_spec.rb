...
RSpec.describe PhonecontactsController, type: :controller do
  ...
  let(:valid_attributes) { { name: 'Jane Doe', phone_number: '+11999999999', notes: 'Jane Doe address' } }
  let(:invalid_attributes) { { name: '', phone_number: 'invalid', notes: '' } }
  let(:new_attributes) { { name: 'John Updated', phone_number: '+15555555555', notes: 'John updated example' } }
